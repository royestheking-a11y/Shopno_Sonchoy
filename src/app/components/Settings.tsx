          ...
          {activeTab === 'profile' && (
            <div className="max-w-2xl space-y-6">
              ...
              <div className="flex items-center gap-6 mb-6">
                <img 
                  src={`https://api.dicebear.com/7.x/notionists/svg?seed=${user.email || user.name}&backgroundColor=e2e8f0,c7d2fe,fde68a`} 
                  alt="Auto Avatar" 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" defaultValue={user.name} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t('settings.member_id_role')}</label>
                  <input type="text" defaultValue={user.memberId || user.id} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t('settings.email')}</label>
                  <input type="email" defaultValue={user.email} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t('settings.phone')}</label>
                  <input type="text" defaultValue={user.phone || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Alternate Phone</label>
                  <input type="text" defaultValue={user.alternatePhone || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">NID Number</label>
                  <input type="text" defaultValue={user.nidNumber || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Address</label>
                  <input type="text" defaultValue={user.address || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Nominee Name</label>
                  <input type="text" defaultValue={user.nomineeName || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Nominee Phone</label>
                  <input type="text" defaultValue={user.nomineePhone || '-'} disabled className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 rounded-xl text-sm outline-none text-slate-500 cursor-not-allowed" />
                </div>
              </div>
            </div>
          )}
